  ...
  return (
    <section className="py-20 bg-gray-50" id="testimonials">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {/* Combined Stats and Testimonials */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Card 1 - Combines 3.2x stat with Sarah's testimonial */}
          <div className="bg-white p-8 rounded-xl shadow-md flex flex-col h-full">
            <div className="text-4xl font-bold text-blue-600 mb-2 text-center">3.2x</div>
            <p className="text-gray-700 mb-6 text-center">Faster skill acquisition compared to unstructured learning</p>
          ...
          {/* Card 2 - Combines 85% stat with Michael's testimonial */}
          <div className="bg-white p-8 rounded-xl shadow-md flex flex-col h-full">
            <div className="text-4xl font-bold text-blue-600 mb-2 text-center">85%</div>
            <p className="text-gray-700 mb-6 text-center">Higher course completion rate with structured learning paths</p>
          ...
          {/* Card 3 - Combines 94% stat with Priya's testimonial */}
          <div className="bg-white p-8 rounded-xl shadow-md flex flex-col h-full">
            <div className="text-4xl font-bold text-blue-600 mb-2 text-center">94%</div>
            <p className="text-gray-700 mb-6 text-center">Of users report better understanding of complex topics</p>
