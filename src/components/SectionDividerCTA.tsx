  ...
  return (
    <div className={`py-8 ${bgColor}`}>
      <div className="container mx-auto px-4 max-w-6xl text-center">
        <button 
          onClick={handleClick}
          className={`px-8 py-3 ${buttonBgColor} text-white font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all duration-200`}
        >
          {buttonText}
        </button>
      </div>
